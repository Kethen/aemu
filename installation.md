...
- <details>
	<summary>Classic P2P mode

	**DO NOT DO THIS IF YOU DON'T KNOW WHAT CLASSIC P2P MODE MEANS**

	</summary>

	classic P2P mode can be enabled by renaming `kd/aemu_postoffice.prx` to `kd/aemu_postoffice.prx.bak`
