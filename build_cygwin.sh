...
podman run \
	...
	mkdir server_win
	cd server_win
	x86_64-pc-cygwin-gcc -I../sqlite3_win_prebuilt -L../sqlite3_win_prebuilt -I../pspnet_adhocctl_server ../pspnet_adhocctl_server/*.c -Wl,-Bdynamic -lsqlite3 -o pspnet_adhocctl_server.exe --static
